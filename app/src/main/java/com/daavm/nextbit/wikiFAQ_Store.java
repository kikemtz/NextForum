...
public class wikiFAQ_Store extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    public void backerkit(View view)
    {
        Uri uri = Uri.parse("https://robin-the-smarter-smartphone.backerkit.com/hosted_preorders");
        Intent intent5 = new Intent(Intent.ACTION_VIEW, uri);
        startActivity(intent5);
    }
    public void home(View view)
    {
        Intent intent = new Intent(wikiFAQ_Store.this,MainActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.store) {
            ...
            Intent intent2 = new Intent(wikiFAQ_Store.this,wiki.class);
            ...
            Intent intent2 = new Intent(wikiFAQ_Store.this,Preferences.class);
            startActivity(intent2);
        } else if (id == R.id.Community) {
            Intent intent2 = new Intent(wikiFAQ_Store.this,MainActivity.class);
            startActivity(intent2);
        }  else if (id == R.id.messages) {
            Intent intent2 = new Intent(wikiFAQ_Store.this,Messages.class);
            startActivity(intent2);
        }  else if (id == R.id.notifications) {
            Intent intent2 = new Intent(wikiFAQ_Store.this,Notifications.class);
            startActivity(intent2);
        }  else if (id == R.id.signin) {
            Intent intent2 = new Intent(wikiFAQ_Store.this,Login.class);
            startActivity(intent2);;
        }   else if (id == R.id.forumsettings) {
            Intent intent2 = new Intent(wikiFAQ_Store.this,forumsettings.class);
            startActivity(intent2);
        }
