...
public class wikiFAQ_Hardware extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    public void home(View view)
    {
        Intent intent = new Intent(wikiFAQ_Hardware.this,MainActivity.class);
        startActivity(intent);
    }
    public void hardware(View view)
    {
        Intent intent2 = new Intent(wikiFAQ_Hardware.this,wikiHardware.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.store) {
            ...
            Intent intent2 = new Intent(wikiFAQ_Hardware.this,wiki.class);
            startActivity(intent2);
            ...
            Intent intent2 = new Intent(wikiFAQ_Hardware.this,Preferences.class);
            startActivity(intent2);
        } else if (id == R.id.Community) {
            Intent intent2 = new Intent(wikiFAQ_Hardware.this,MainActivity.class);
            startActivity(intent2);
        }  else if (id == R.id.messages) {
            Intent intent2 = new Intent(wikiFAQ_Hardware.this,Messages.class);
            startActivity(intent2);
        }  else if (id == R.id.notifications) {
            Intent intent2 = new Intent(wikiFAQ_Hardware.this,Notifications.class);
            startActivity(intent2);
        }  else if (id == R.id.signin) {
            Intent intent2 = new Intent(wikiFAQ_Hardware.this,Login.class);
            startActivity(intent2);;
        }   else if (id == R.id.forumsettings) {
            Intent intent2 = new Intent(wikiFAQ_Hardware.this,forumsettings.class);
            startActivity(intent2);
        }
