...
public class Messages extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.store) {
            ...
            Intent intent2 = new Intent(Messages.this,wiki.class);
            ...
            Intent intent2 = new Intent(Messages.this,Preferences.class);
            startActivity(intent2);
            ...
            Intent intent2 = new Intent(Messages.this,Messages.class);
            startActivity(intent2);
