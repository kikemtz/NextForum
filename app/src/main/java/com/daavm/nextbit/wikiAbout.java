...
public class wikiAbout extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    public void home(View view)
    {
        Intent intent = new Intent(wikiAbout.this,MainActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.store) {
            ...
            Intent intent2 = new Intent(wikiAbout.this,wiki.class);
            ...
            Intent intent2 = new Intent(wikiAbout.this,Preferences.class);
            startActivity(intent2);
        } else if (id == R.id.Community) {
            Intent intent2 = new Intent(wikiAbout.this,MainActivity.class);
            startActivity(intent2);
        }  else if (id == R.id.messages) {
            Intent intent2 = new Intent(wikiAbout.this,Messages.class);
            startActivity(intent2);
        }  else if (id == R.id.notifications) {
            Intent intent2 = new Intent(wikiAbout.this,Notifications.class);
            startActivity(intent2);
        }  else if (id == R.id.signin) {
            Intent intent2 = new Intent(wikiAbout.this,Login.class);
            startActivity(intent2);;
        }   else if (id == R.id.forumsettings) {
            Intent intent2 = new Intent(wikiAbout.this,forumsettings.class);
            startActivity(intent2);
        }
