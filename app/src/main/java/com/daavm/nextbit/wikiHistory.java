...
public class wikiHistory extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.store) {
            ...
            Intent intent2 = new Intent(wikiHistory.this,wiki.class);
            ...
            Intent intent2 = new Intent(wikiHistory.this,Preferences.class);
            startActivity(intent2);
        } else if (id == R.id.Community) {
            Intent intent2 = new Intent(wikiHistory.this,MainActivity.class);
            startActivity(intent2);
        }  else if (id == R.id.messages) {
            Intent intent2 = new Intent(wikiHistory.this,Messages.class);
            startActivity(intent2);
        }  else if (id == R.id.notifications) {
            Intent intent2 = new Intent(wikiHistory.this,Notifications.class);
            startActivity(intent2);
