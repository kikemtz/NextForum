...
public class wikiFAQ_General extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    public void RobinMap(View view)
    {
        Uri uri = Uri.parse("https://www.google.com/maps/d/u/0/viewer?mid=ziOWsSVuF6UI.keexsu5ypyfw");
        Intent intent5 = new Intent(Intent.ACTION_VIEW, uri);
        startActivity(intent5);
    }
    public void home(View view)
    {
        Intent intent = new Intent(wikiFAQ_General.this,MainActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.store) {
            ...
            Intent intent2 = new Intent(wikiFAQ_General.this,wiki.class);
            ...
            Intent intent2 = new Intent(wikiFAQ_General.this,Preferences.class);
            startActivity(intent2);
        } else if (id == R.id.Community) {
            Intent intent2 = new Intent(wikiFAQ_General.this,MainActivity.class);
            startActivity(intent2);
        }  else if (id == R.id.messages) {
            Intent intent2 = new Intent(wikiFAQ_General.this,Messages.class);
            startActivity(intent2);
        }  else if (id == R.id.notifications) {
            Intent intent2 = new Intent(wikiFAQ_General.this,Notifications.class);
            startActivity(intent2);
        }  else if (id == R.id.signin) {
            Intent intent2 = new Intent(wikiFAQ_General.this,Login.class);
            startActivity(intent2);;
        }   else if (id == R.id.forumsettings) {
            Intent intent2 = new Intent(wikiFAQ_General.this,forumsettings.class);
            startActivity(intent2);
        }
