...
public class forumsettings extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.store) {
            ...
            Intent intent2 = new Intent(forumsettings.this,wiki.class);
            ...
            Intent intent2 = new Intent(forumsettings.this,Preferences.class);
            startActivity(intent2);
            ...
            Intent intent2 = new Intent(forumsettings.this,Messages.class);
            startActivity(intent2);
