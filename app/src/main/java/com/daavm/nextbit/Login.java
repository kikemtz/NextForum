...
public class Login extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.store) {
            ...
            Intent intent2 = new Intent(Login.this,wiki.class);
            ...
            Intent intent2 = new Intent(Login.this,Preferences.class);
            startActivity(intent2);
            ...
            Intent intent2 = new Intent(Login.this,Messages.class);
            startActivity(intent2);
